   ...
   console.log(this.state.statewis)
    ...
    return (
      <div className="container">
        ...
        <div className="state-selector" style={{padding:"2vh", backgroundColor:"orange",boxShadow: "0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)",position:'sticky', top: '0px'}} >
